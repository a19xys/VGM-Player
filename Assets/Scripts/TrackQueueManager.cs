...
public class TrackQueueManager : MonoBehaviour {
    ...
    /// <summary>
    /// Sincroniza la cola con un ID de canción (p.ej., si se cambia desde fuera).
    ...
    public void NotifyFilteredListChanged() {
        ...
        BuildShuffleOrder();
        RecenterShuffleOn(currentIndex);
        // history no se borra aquí para poder volver en shuffle a pistas previas
    }

    /* ===================== API PARA LA TRANSICIÓN ===================== */
